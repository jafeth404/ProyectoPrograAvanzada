        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiereEmpaque = table.Column<bool>(type: "bit", nullable: false),
                    CostoEmpaque = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostoEmpaque = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    CostoDelivery = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacturaDetalles", x => x.DetalleFacturaId);
                    table.ForeignKey(
